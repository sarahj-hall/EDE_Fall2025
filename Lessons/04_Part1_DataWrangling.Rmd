...
head(NTL.phys.data) #first couple rows 
summary(NTL.phys.data) #summary stats of table
str(NTL.phys.data) #datatype of the df
dim(NTL.phys.data)
...
```{r arranging data}
NTL.phys.data.depth.ascending <- arrange(NTL.phys.data, depth) #default is ascending order 
