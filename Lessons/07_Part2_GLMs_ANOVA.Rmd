...
#filter data inside of the function for site ID 
...
#hsd tries to find groups across the different levels that have a similiar mean
#group = true, group levels with same mean 
...
> re-order plot with same order as hsd.test 
