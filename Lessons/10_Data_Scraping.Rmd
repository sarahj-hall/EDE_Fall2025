...
#returns a character vector (will need to convert later on)
...
ggplot(df_withdrawals,aes(x=Date,y=Avg_Withdrawals_mgd)) + 
  ...
  labs(title = paste("2024 Water usage data for",the_registrant),
...
#Subset the facilities, grab 20 at random
